...
class InvoiceTemplateMinimalSlate extends StatelessWidget {
  final Map<String, dynamic> billData;
  final List<Map<String, dynamic>> itemsData;

  const InvoiceTemplateMinimalSlate({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    const slateColor = Color(0xFF334155);
    const slateBg = Color(0xFFF1F5F9);
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: slateColor.withValues(alpha: 0.3), width: 2),
        boxShadow: [
          BoxShadow(
            color: slateColor.withValues(alpha: 0.08),
            blurRadius: 10,
              ...
              children: [
                Column(
                  ...
                  children: [
                    ...
                    Text(
                      billData['shop_address'] ?? 'Minimal Slate Receipt',
                ...
                Container(
                  ...
                  child: Text(
                    'SLATE',
                    style: GoogleFonts.outfit(color: slateColor, fontSize: 10, fontWeight: FontWeight.w900),
                  ),
                ),
              ],
            ),
            ...
            child: Row(
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    Text('Bill #${billData['bill_number']}', style: GoogleFonts.outfit(fontSize: 11, fontWeight: FontWeight.bold, color: slateColor)),
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: slateBg,
                  borderRadius: BorderRadius.circular(8),
                  border: Border.all(color: slateColor),
                ),
                child: Text(
                  'TOTAL: ₹${fmt.format(grandTotal)}',
                  style: GoogleFonts.outfit(fontSize: 14, fontWeight: FontWeight.w900, color: slateColor),
                ),
              ),
            ],
          ),
