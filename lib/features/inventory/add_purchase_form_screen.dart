...
class _AddPurchaseFormScreenState extends State<AddPurchaseFormScreen> {
            ...
            children: [
              Expanded(
                child: TextFormField(
                  ...
                  keyboardType: TextInputType.number,
                  decoration: const InputDecoration(labelText: 'Purchase Rate (Γé╣) *', prefixText: 'Γé╣ ', border: OutlineInputBorder()),
                  onChanged: (v) {
                    setState(() {
  ...
  Widget _buildPaymentStatusBadge() {
    ...
    if (paid == 0) {
      statusText = 'UNPAID (Due: Γé╣${due.toStringAsFixed(2)})';
      statusColor = Colors.red.shade700;
      statusIcon = Icons.error_outline;
    } else if (paid < total) {
      statusText = 'PARTIAL (Due: Γé╣${due.toStringAsFixed(2)})';
        ...
        children: [
          Row(
            ...
            children: [
              ...
              Text('Γé╣${_totalPurchaseAmount.toStringAsFixed(2)}', style: GoogleFonts.outfit(fontSize: 18, fontWeight: FontWeight.bold, color: AppColors.royalBlue)),
            ],
          ),
          ...
          TextFormField(
            ...
            decoration: const InputDecoration(labelText: 'Amount Paid Now (Γé╣)', prefixText: 'Γé╣ ', filled: true, fillColor: Colors.white, border: OutlineInputBorder()),
          ),
          const SizedBox(height: 12),
